...
var bullet = makeSquare(5, 5, 20, 20);
...
function makeEnemy() {
    ...
    var enemyY = Math.round(Math.random() * (canvas.height - enemySize * 4)) + enemySize;
