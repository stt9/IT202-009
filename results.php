...
?>
    <h2>Results for: <?php echo $name ?></h2>
                    ...
                    <div class="list-group-item">
                        ...
                        <div>
                            <?php foreach ($question["answers"] as $answer): ?>
                                ...
                                <p class="text-center"><?php safer_echo($answer["answer"]); ?><b><?php echo " ". (round(((count($percentage[$qid][$aid])/count($percentage[$qid]["answer counter"]))*100))) . "%"; ?></p></b>
                            <?php endforeach; ?>
                        </div>
                    </div>
                <?php endforeach; ?>
